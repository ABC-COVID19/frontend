   ...
   <div class="container" id="containerTop">
      <div class="row">
         <div class="col-12 mb-3">
            ...
            <p class="page-name  mt-2">Actualizações ICAM</p>
            </h2>
         </div>
      </div>
   </div>
...
<div id="main-content">
   <div class="container">
      ...
      <div class="textBoxmain  text-left">
			  ...
			  <div id="afterSumbit" class="d-none">
					<div class="form-group row">
					   <div class="col-12">
						 <h2 class="fontCblue font-weight-bold mt-2">Formulário submetido com sucesso</h2>
						  <br>
						  Obrigado. A sua submissão foi recebida com sucesso!
						  <ul class="contact-icons text-center list-unstyled">
							<li>
							  <i class="fas fa-envelope fa-2x black-text"></i>
							  <p><a href="mailto:geral@icam.org.pt">geral@icam.org.pt</a></p>
							</li>
						  </ul>						  
					   </div>
					</div> 
